...
#Pitch_avg, jitter_avg, shimmer_avg, Formant1_avg, Formant2_avg, Formant3_avg = RetrievePitch(Pitch, jitter, shimmer, Formant1, Formant2, Formant3)
...
#plotHistogram(shimmer_avg, "Shimmer", " ")
#plotHistogram(Formant1_avg, "Formant 1", " ")
#plotHistogram(Formant2_avg, "Formant 2", " ")
#plotHistogram(Formant3_avg, "Formant 3", " ")
